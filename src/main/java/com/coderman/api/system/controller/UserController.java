...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseBean login(@NotBlank
                                      // 用来校验 String 类型的参数是否为空的
                                      (message = "账号必填") String username,
    ...
    public ResponseBean findUserList(@RequestParam
    ...
    public ResponseBean assignRoles(@PathVariable
                                            //用在参数里用来提取url中的请求参数
                                            Long id,
                                    @RequestBody
